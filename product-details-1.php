                ...
                <div class="col-7 col-md-7 left-content-detail-product">
                    <div class="row">
                        <div class="col-2 col-md-2">
                            <div class="preview-thumbnail-image-product" id="img-preview-banner">
                                <div class="preview-product-image img-active">
                                    <img src="assets/img/img-component/product-in-the-shower.png" alt="" class="img-fluid">
                                </div>
