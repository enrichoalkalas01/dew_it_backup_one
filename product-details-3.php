...
<body>
    ...
    <!-- Banner -->
    <section id="banner-product-detail">
        <div class="container-fluid p-0">
            <div class="row banner-hero-product-details d-flex justify-content-center">
                        ...
                        <div class="col-2 col-md-2">
                            <div class="preview-thumbnail-image-product">
                                <div class="preview-product-image img-active">
                                    <img src="assets/img/img-component/product-before-bed.png" alt="" class="img-fluid">
                                </div>
                ...
                <div class="col-5 col-md-5 right-content-detail-product">
                    <h4>Before Bed</h4>
                    <h1>Body Mask</h1>
                    <h6>Balanced Moisture & Longer Lasting</h6>
                    ...
                    <div class="accordion" id="accordion-product-info">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion-product-info">
                                <div class="card-body">
                                    <p>
                                        <span>Step 1</span>: Place your Dew It® Body Mask next to your bed side
                                    </p>
                                    <p>
                                        <span>Step 2</span>: Open the jar, dab the sponge on the mask
                                    </p>
                                    <p>
                                        <span>Step 3</span>: Place the mask all over your arms and legs and massage it evenly
                                    </p>
                                    <p>
                                        We know you like to #DewIt in bed!
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row d-flex justify-content-center">
                    ...
                    <div class="card card-product-others" id="product-1">
                        <div class="row">
                            <div class="col-6 col-md-5 image-product-detail">
                                <img src="assets/img/img-component/in-the-shower.png" alt="" class="img-fluid in-the-shower">
                            </div>
                ...
                <div class="col-12 col-md-6 card-other-product stretch-card">
                    ...
                    <div class="card card-product-others" id="product-2">
                        <div class="row">
                            <div class="col-6 col-md-5 image-product-detail">
                                <img src="assets/img/img-component/on-the-go.png" alt="" class="img-fluid">
                            </div>
                            <div class="col-6 col-md-7 desc-product-detail">
                                <h1>BODY POLISH</h1>
                                <p>
                                    No time in the morning? Not to worry we have an on-the-go solution for you! Wear it in the car, in the bus, on the MRT or even while walking!
                                </p>
                                <div class="price-troli-others d-flex justify-content-between">
                                    <div class="list-price">
                                        <p>Rp 150.000</p>
    ...
    <script type="text/javascript">
        ...
        $('#banner-product-detail .left-content-detail-product .preview-thumbnail-image-product .preview-product-image').on('click', function(event) {
            event.preventDefault();
            /* Act on the event */

            $('#banner-product-detail .left-content-detail-product .preview-thumbnail-image-product .preview-product-image').removeClass('img-active');
            $(this).addClass('img-active');
            let data_img = $(this).find('img').attr('src');
            $('#banner-product-detail .main-preview-product-image').find('img').attr('src', data_img)
